...
contract L0b is Ownable, ERC721, ILayerZeroReceiver {

    address public _owner;
    string private baseURI;
    uint256 nextTokenId = 9942;
    uint256 MAX_MINT_BINANCE = 10848;
    ...
    function mint(uint8 numTokens) external payable {
        ...
        require(nextTokenId + numTokens - 1 < MAX_MINT_BINANCE, "GG: Mint exceeds supply");
