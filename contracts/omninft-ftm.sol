...
// File: contracts/OmniNFTftm.sol

pragma solidity ^0.8.7;

contract OmniNFTftm is Ownable, ERC721, NonblockingReceiver {
    address public _owner;
    string private baseURI;
    uint256 nextTokenId = 400;
    uint256 MAX_MINT_FANTOM = 500;

    uint256 gasForDestinationLzReceive = 350000;

    constructor(string memory baseURI_, address _layerZeroEndpoint)
        ERC721("OmniNFTftm", "ONFT")
    {
        _owner = msg.sender;
    ...
    function mint(uint8 numTokens) external payable {
        ...
        require(
            nextTokenId + numTokens <= MAX_MINT_FANTOM,
            "Mint exceeds supply"
        );
