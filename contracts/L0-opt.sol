...
contract L0o is Ownable, ERC721, ILayerZeroReceiver {

    address public _owner;
    string private baseURI;
    uint256 nextTokenId = 10989;
    uint256 MAX_MINT_OPTIMISM = 11011;
    ...
    function mint(uint8 numTokens) external payable {
        ...
        require(nextTokenId + numTokens - 1 < MAX_MINT_OPTIMISM, "GG: Mint exceeds supply");
