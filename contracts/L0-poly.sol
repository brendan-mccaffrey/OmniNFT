...
contract L0p is Ownable, ERC721, ILayerZeroReceiver {

    address public _owner;
    string private baseURI;
    uint256 nextTokenId = 9264;
    uint256 MAX_MINT_POLYGON = 9518;
    ...
    function mint(uint8 numTokens) external payable {
        ...
        require(nextTokenId + numTokens - 1 < MAX_MINT_POLYGON, "GG: Mint exceeds supply");
