...
async function main() {
    ...
    // let resp = await contract.setTrustedRemote(arbId, arbAddr);
    // // console.log(resp);
    // console.log("Set ARB remote");
    // let resp = await contract.setTrustedRemote(bscId, bscAddr);
    // // console.log(resp);
    // console.log("Set BSC remote");
    // let resp = await contract.setTrustedRemote(avaxId, avaxAddr);
    // // console.log(resp);
    // console.log("Set AVAX remote");
    // let resp = await contract.setTrustedRemote(polyId, polyAddr);
    // // console.log(resp);
    // console.log("Set POLY remote");
    // let resp = await contract.setTrustedRemote(optId, optAddr);
    // // console.log(resp);
    // console.log("Set OPT remote");
    let resp = await contract.setTrustedRemote(ftmId, ftmAddr);
    // console.log(resp);
